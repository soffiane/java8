...
public class Main {
    public static void main(String[] args) {
        ...
        facture.increment(s -> {
            return s + "-01";
        }); //ou plus simplement f.increment(s -> s+"-01");
        System.out.println(facture.getNumero());
        ...
        String res = client.lierClientAFacture((c, f) -> {
            return c.getNom() + f.getNumero();
        });
        //ou encore String res = client.lierClientAFacture((c, f) -> c.getNom() + f.getNumero());
